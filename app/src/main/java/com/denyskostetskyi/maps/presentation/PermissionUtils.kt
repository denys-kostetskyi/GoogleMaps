...
object PermissionUtils {
    ...
    /**
     * This method checks whether the app has been granted permission to access the device's
     * precise location (fine location) or approximate location (coarse location).
     *
     * @param context The context used to access system services and check permissions.
